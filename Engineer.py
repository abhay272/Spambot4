...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await idk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await idk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await idk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ydk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ydk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ydk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await wdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await wdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await wdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await hdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await hdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await hdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await sdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await sdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await sdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await adk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await adk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await adk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await bdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await bdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await bdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await cdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await cdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await cdk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ddk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ddk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ddk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await edk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await edk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await edk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await vkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await vkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await vkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await kkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await kkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await kkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await lkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await lkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await lkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await mkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await mkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await mkk(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await sid(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await sid(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await sid(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await shy(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await shy(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await shy(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await aan(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await aan(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await aan(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ake(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ake(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await ake(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await eel(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await eel(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await eel(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await khu(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await khu(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await khu(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await shi(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await shi(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await shi(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await yaa(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await yaa(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await yaa(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await dav(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await dav(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await dav(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await raj(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await raj(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await raj(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await put(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await put(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            await put(functions.channels.JoinChannelRequest(channel="@fullchatbazzi"))
            botid = telethon.utils.get_peer_id(botme)
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            bio = str(yukki[0])
            text = "𝐁𝐈𝐎 𝐂𝐇𝐀𝐍𝐆𝐈𝐍𝐆 𝐖𝐀𝐈𝐓"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await e.client(functions.account.UpdateProfileRequest(about=bio))
                await event.edit("𝐁𝐈𝐎 𝐂𝐇𝐀𝐍𝐆𝐈𝐍𝐆 𝐃𝐎𝐍𝐄 ✅")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐀𝐑𝐇𝐀 𝐓𝐄𝐑𝐈 𝐆𝐀𝐍𝐃 𝐌𝐀𝐑𝐍𝐄")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
USTAD_PIC = "https://te.legra.ph/file/7d1507f296450941b12bf.jpg"
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        start = datetime.now()
        text = "𓆩𝘿𝘼𝙆𝙐〆𝙀𝙉𝙂𝙄𝙉𝙀𝙀𝙍𓆪"
        event = await e.reply(text, parse_mode=None, link_preview=None )
        end = datetime.now()
        ms = (end-start).microseconds / 500
        await event.edit(f"𓆩𝙀𝙉𝙂𝙄𝙉𝙀𝙀𝙍𓆪 \n`{ms}` 𝗺𝘀")
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀\n\n𝙐𝙩𝙞𝙡𝙨 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.ping\n.restart\n\n𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.bio\n.sudo\n.join\n.pjoin\n.oword\n.leave\n\n𝙎𝙥𝙖𝙢 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.spam\n.pornspam\n.delayspam\n.bigspam\n.raid\n.mraid\n.sraid\n.jraid\n.craid\n.replyraid\n.dreplyraid\n\n\n𝐹𝑂𝑅 𝑀𝑂𝑅𝐸 𝐻𝐸𝐿𝑃 𝑅𝐸𝐺𝐴𝑅𝐷𝐼𝑁𝐺 𝑈𝑆𝐴𝐺𝐸 𝑂𝐹 𝑃𝐿𝑈𝐺𝐼𝑁𝑆 𝑇𝑌𝑃𝐸 𝑃𝐿𝑈𝐺𝐼𝑁𝑆 𝑁𝐴𝑀𝐸 TO JOIN @fullchatbazzi"
       await e.reply(text, parse_mode=None, link_preview=None )
